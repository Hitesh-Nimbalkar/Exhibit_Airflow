    ...
    def start_model_training(self):
        ...
        try:
            ...
            if not os.path.exists(params_file):
                ...
                best_model_name,best_model, best_r2_score, best_params=self.model_selection(X_test=X_test,X_train=X_train,
                ...
                r2_score,fitted_model=self.fit_and_evaluate_model(X_train=X_train,
                                                                X_test=X_test,
            ...
            if not contents:
                ...
                artifact_model_score=float(best_r2_score)
            ...
            Exp_eval.run_mlflow_experiment(R2_score=R2_score,model=model,parameters=parameters,model_name=param_model_name)    
